		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PPL Planning Worklist",
									"targetURL": "#tbsplworklist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tbsplworklist-display": {
								"semanticObject": "tbsplworklist",
								"action": "display",
								"description": "PPL Planning Worklist.",
								"title": "PPL Planning Worklist",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tbspl.worklist",
									"url": sap.ui.require.toUrl("tbspl/worklist")
								}
							}
						}
					}
